...
def save_comment_information(awarding_comment, awarded_comment, submission):
    ...
    comment_info = {
        ...
        'awarded_id'              : 't1_'+ awarded_comment.id if awarded_comment is not None else None,
        ...
        'awarded_author'          : awarded_comment.author.name if awarded_comment is not None else None,
        'submission_author'       : submission.author.name,
        'awarding_timestamp'      : int(awarding_comment.created_utc),
        'awarded_timestamp'       : int(awarded_comment.created_utc) if awarded_comment is not None else None,
        'submission_timestamp'    : int(submission.created_utc),
        'awarding_body'           : awarding_comment.body,
        'awarded_body'            : awarded_comment.body if awarded_comment is not None else None,
        'awarded_score'           : awarded_comment.score if awarded_comment is not None else None,
